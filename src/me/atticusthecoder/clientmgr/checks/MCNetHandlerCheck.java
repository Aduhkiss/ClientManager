...
public class MCNetHandlerCheck extends Check implements Listener, PluginMessageListener {
	
	public MCNetHandlerCheck() {
		super("MCNetHandler Check", Client.HACKED_CLIENT_F);
	}
